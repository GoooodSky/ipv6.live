<template>
  <main id="search">
    ...
    <section class="search-button">
      ...
      />
      <button class="search-button-clear" type="button" name="button" @click="clearInput()" v-if="universityInput">
        <i class="el-icon-error"></i>
      </button>
      <button class="search-button-search" type="button" name="button" @click="$store.dispatch('detailVisible', universityInput)">
        探测
      </button>
